...
def init_colors():
    return [
        ...
        ['#282A2E', '#282A2E'],  # color 1
        ['#c0c5ce', '#c0c5ce'],  # color 2
        ['#fba922', '#fba922'],  # color 3
        ['#3384d0', '#3384d0'],  # color 4
        ['#c0c0c0', '#c0c0c0'],  # color 5
...
def init_widgets_defaults():
    return dict(
        font='Ubuntu bold', fontsize=12, padding=2, background=colors[1]
    )
...
monitor_widgets_list = init_monitor_widgets_list()
...
def init_widgets_screen2():
    return init_monitor_widgets_list()
...
def init_screens():
    return [
        Screen(
            top=bar.Bar(widgets=init_widgets_screen1(), size=30, opacity=1)
        ),
        Screen(
            top=bar.Bar(widgets=init_widgets_screen2(), size=30, opacity=1)
        ),
        Screen(
            top=bar.Bar(widgets=init_widgets_screen3(), size=30, opacity=1)
        ),
    ]
